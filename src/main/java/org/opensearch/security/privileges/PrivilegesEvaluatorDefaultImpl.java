...
public class PrivilegesEvaluatorDefaultImpl implements PrivilegesEvaluator {
    ...
    public PrivilegesEvaluatorDefaultImpl(
        ...
        if (clusterService != null) {
            clusterService.addListener(event -> {
                ActionPrivileges actionPrivileges = PrivilegesEvaluatorDefaultImpl.this.actionPrivileges.get();
    ...
    @Override
    public PrivilegesEvaluatorResponse hasExplicitIndexPrivilege(PrivilegesEvaluationContext context, Set<String> actions, String index) {
        return getActionPrivileges().hasExplicitIndexPrivilege(context, actions, Resolved.ofIndex(index));
    }
    ...
    public PrivilegesEvaluatorResponse hasAnyClusterPrivilege(PrivilegesEvaluationContext context, Set<String> actions) {
        return getActionPrivileges().hasAnyClusterPrivilege(context, actions);
    }
}
